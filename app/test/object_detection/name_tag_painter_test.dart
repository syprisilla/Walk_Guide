...
import 'package:walk_guide/object_detection/name_tag_painter.dart';
...
void main() {
  group('NameTagUtils Tests', () {
    ...
    testWidgets('paintNameTag가 일반적인 경우 오류 없이 실행되어야 함',
    ...
    testWidgets('객체가 화면 상단 가장자리에 있을 때 위치 조정 로직이 실행되어야 함',
        (WidgetTester tester) async {
    ...
    testWidgets('캔버스 높이가 매우 작고 객체가 상단에 있을 때 중첩된 위치 조정 로직이 실행되어야 함',
        (WidgetTester tester) async {
