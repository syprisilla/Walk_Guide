...
import 'package:walk_guide/object_detection/object_painter.dart';
  ...
  group('ObjectPainter Tests', () {
    ...
    test('shouldRepaint returns true when objects change', () {
      final painter1 = ObjectPainter(
          ...
          cameraPreviewAspectRatio: defaultCameraPreviewAspectRatio,
          showNameTags: false);
      final painter2 = ObjectPainter(
          objects: [],
          imageSize: defaultImageSize,
          screenSize: defaultScreenSize,
          rotation: InputImageRotation.rotation0deg,
    ...
    test('shouldRepaint returns false when all properties are the same', () {
      ...
      expect(painter1.shouldRepaint(painter1.copyWith()),
          isFalse); // Using copyWith for clarity
    });

    testWidgets('paint method with empty imageSize returns early',
        (WidgetTester tester) async {
      await pumpPainter(tester,
          objects: [mockDetectedObjectWithLabel], imageSize: Size.zero);
    ...
    testWidgets('paint method with empty screenSize returns early',
        (WidgetTester tester) async {
      await pumpPainter(tester,
          objects: [mockDetectedObjectWithLabel], screenSize: Size.zero);
      expect(tester.takeException(), isNull);
    });

    testWidgets('paint method with zero cameraPreviewAspectRatio returns early',
        (WidgetTester tester) async {
      await pumpPainter(tester,
          objects: [mockDetectedObjectWithLabel], cameraPreviewAspectRatio: 0);
      expect(tester.takeException(), isNull);
    });

    for (var rotation in InputImageRotation.values) {
      testWidgets(
          'paint method runs without error for rotation: ${rotation.name}',
          (WidgetTester tester) async {
        await pumpPainter(tester,
            objects: [mockDetectedObjectWithLabel], rotation: rotation);
        expect(tester.takeException(), isNull);
      });
    }

    testWidgets(
        'paint method with screenAspectRatio > cameraPreviewAspectRatio',
        (WidgetTester tester) async {
      await pumpPainter(
        tester,
        objects: [mockDetectedObjectWithLabel],
    ...
    testWidgets('paint method with mlImageWidth effectively zero',
        (WidgetTester tester) async {
      await pumpPainter(
        tester,
        objects: [mockDetectedObjectWithLabel],
    ...
    testWidgets('paint method with mlImageHeight effectively zero',
        (WidgetTester tester) async {
      await pumpPainter(
        tester,
        objects: [mockDetectedObjectWithLabel],
    ...
    testWidgets('paint method for front camera on Android',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'paint method shows name tag when showNameTags is true and labels exist',
        (WidgetTester tester) async {
      await pumpPainter(
        tester,
        objects: [mockDetectedObjectWithLabel],
    ...
    testWidgets(
        'paint method does not show name tag when showNameTags is false',
        (WidgetTester tester) async {
      await pumpPainter(
        tester,
        objects: [mockDetectedObjectWithLabel],
    ...
    testWidgets('paint method does not show name tag when labels are empty',
        (WidgetTester tester) async {
      await pumpPainter(
        tester,
    ...
    testWidgets('paint method with name tag near top edge',
        (WidgetTester tester) async {
    ...
    testWidgets('paint method with name tag near bottom edge',
        (WidgetTester tester) async {
    ...
    testWidgets('paint method with very narrow bounding box',
        (WidgetTester tester) async {
  ...
  ObjectPainter copyWith({
    ...
    return ObjectPainter(
      ...
      cameraPreviewAspectRatio:
          cameraPreviewAspectRatio ?? this.cameraPreviewAspectRatio,
