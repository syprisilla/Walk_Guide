...
class _StepCounterPageState extends State<StepCounterPage> {
      ...
      body: Stack( //
        children: [
          ...
          Positioned( //
              ...
              right: 0, //
              child: Padding( //
                padding: const EdgeInsets.symmetric(horizontal: 4.0), // Reduced from 6.0
                child: Container( //
                  padding: const EdgeInsets.symmetric( //
                      vertical: 2.0, horizontal: 4.0), // Reduced from 4.0, 6.0
                  ...
                  child: Row( //
                    ...
                    children: [
                      ...
                      Container( //
                        height: 25, // Reduced from 50
                        width: 1, //
                        color: Colors.white30, //
                        margin: const EdgeInsets.symmetric(horizontal: 5), // Reduced from 8
                      ),
                      Expanded( //
                        child: Column( //
                          mainAxisSize: MainAxisSize.min, //
                          ...
                          children: [
                            const Text('평균 속도', //
                                style: TextStyle( //
                                    fontSize: 6, color: Colors.white70)), // Reduced from 8
  ...
  void dispose() {
    ...
    print("StepCounterPage disposed and orientation set to portrait.");
